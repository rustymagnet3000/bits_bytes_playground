...
# 3        \--->List['Findings']
# 4            \--->Dict
big_dict = {'ResponseMetadata': {'RequestId': 'xxxxxx-04e9-xxxx-xxx-xxxxxx',
                                 'HTTPStatusCode': 200,
...
for key, value in big_dict.items():
    ...
    if isinstance(value, list):
        ...
        # 4 Get the Dict out of the 3
        dict_to_print = value[0]

        # 4 print all items in dictionary
        print(f'[*]Print each key-value pair from List')
        for v in dict_to_print.items():
            print("[*]", v)